...
function saveAsText(data, name){
    var link = document.createElement("a");
    link.download = name;
    link.href = 'data:text/plain;base64,'+Base64.encode(data);
...
function saveAsImage(data, name){
    var link = document.createElement("a");
    link.download = name;
    link.href = data.replace(/image\/png|image\/jpg|image\/jpeg|image\/gif/g, 'image/octet-stream');
